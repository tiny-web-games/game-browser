...
专为安卓平板与手机深度定制的原生全屏网页游戏浏览器，是 [tiny-web-games](https://github.com/tiny-web-games) 组织开源小游戏的移动端游玩门户。

彻底解决移动端普通浏览器无法真正全屏、上下地址栏/底栏挤占可视面积、系统手势误触、横竖屏频繁错乱以及弱网/离线无法游玩的痛点。
